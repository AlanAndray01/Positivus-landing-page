...
const Teams = () => {
  const teamMembers = [
    {
      ...
      image: '/assets/Teamsimage/ian-dooley-d1UPkiFd04A-unsplash 1.png',
    ...
    },
    {
      ...
      image: '/assets/Teamsimage/suad-kamardeen-khewjy5l4Zo-unsplash 2.png',
    ...
    },
    {
      ...
      image: '/assets/Teamsimage/christian-buehner-DItYlc26zVI-unsplash 1.png',
    ...
    },
    {
      ...
      image: '/assets/Teamsimage/feli-ramsanjami-agung-wUe_Q-t4-cI-unsplash 1.png',
    ...
    },
    {
      ...
      image: '/assets/Teamsimage/chanvre-quebec-mXu1SpzHq6w-unsplash 1.png',
    ...
    },
    {
      ...
      image: '/assets/Teamsimage/alexandra-gorn-smuS_jUZa9I-unsplash 1.png',
  ...
  return (
    <div className='lg:my-20 my-10'>
      {/* Header Section */}
      <div className='flex lg:flex-row flex-col gap-8 items-center lg:items-start my-10'>
        ...
        {teamMembers.map((member, index) => (
          ...
          >
            ...
            <div className='flex items-end gap-4 mb-6 pb-6 border-b border-black'>
              ...
              <div className='relative w-30 h-30 rounded-4xl overflow-hidden bg-[#B9FF66]'>
